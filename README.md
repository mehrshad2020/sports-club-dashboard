...
یک داشبورد کامل و زیبا برای مدیریت باشگاه‌های ورزشی با استفاده از HTML، CSS (bootstrap CSS)، و JavaScript.
...
### 🎨 طراحی و ظاهر
- طراحی مدرن و زیبا با bootstrap CSS
...
- **bootstrap CSS**: فریم‌ورک CSS utility-first
